...
ABOUT = '''
    Формирование процентной скидки на список товаров, заданный при настройке акции.
    Если список товаров НЕ ОПРЕДЕЛЕН, то скидка не производится. 
    '''
SUPPLEMENT = True
FIXED_PRICE = True
...
class ThePage(TheActionPage):
    ...
    def набор_базовых_параметров(self):
        return ['description', 'validity', 
            ...
            Action.ПРОЦЕНТНАЯ_СКИДКА, 'набор_товаров', 
